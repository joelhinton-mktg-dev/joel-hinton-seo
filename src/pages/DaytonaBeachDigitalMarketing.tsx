                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <Select onValueChange={(value) => {
                          ...
                          <SelectContent>
                            <SelectItem value="motorsports">Motorsports & Racing</SelectItem>
                            <SelectItem value="tourism">Tourism & Hospitality</SelectItem>
                            <SelectItem value="beach-services">Beach Services</SelectItem>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <Select onValueChange={(value) => {
                          ...
                          <SelectContent>
                            <SelectItem value="nascar-motorsports">NASCAR & Motorsports</SelectItem>
                            <SelectItem value="tourism-hospitality">Tourism & Hospitality</SelectItem>
                            <SelectItem value="beach-lifestyle">Beach Lifestyle</SelectItem>
                            <SelectItem value="real-estate">Real Estate</SelectItem>
                            <SelectItem value="healthcare">Healthcare</SelectItem>
                            <SelectItem value="professional-services">Professional Services</SelectItem>
                            <SelectItem value="restaurant">Restaurant & Dining</SelectItem>
