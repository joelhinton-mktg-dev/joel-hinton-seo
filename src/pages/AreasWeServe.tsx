...
const contactFormSchema = z.object({
  ...
  selectedService: z.string().default("Local Consultation")
});
...
const AreasWeServe = () => {
  ...
  const { register, handleSubmit, formState: { errors }, reset, setValue } = useForm<ContactFormData>({
    ...
    defaultValues: { selectedService: "Local Consultation" }
  });
  ...
  const onSubmitForm = async (data: ContactFormData) => {
    ...
    if (process.env.NODE_ENV === 'development') {
      console.log("Areas We Serve contact form submitted:", data);
    }
    ...
    <>
      ...
      <Dialog open={isDialogOpen} onOpenChange={(open) => { setIsDialogOpen(open); if (!open) reset(); }}>
        <DialogContent className="max-w-2xl">
          <DialogHeader>
            <DialogTitle>Schedule Your Local Consultation</DialogTitle>
            <DialogDescription>
              Let's discuss your local market opportunities and create a personalized marketing strategy for your area.
            </DialogDescription>
          </DialogHeader>
          ...
          {submitSuccess ? (
            <div className="text-center py-8">
              ...
              <p className="text-muted-foreground">I'll review your information and reach out within 24 hours to schedule your local consultation.</p>
            </div>
          ) : (
            <form onSubmit={handleSubmit(onSubmitForm)} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Input id="selectedService" value="Local Consultation" readOnly {...register('selectedService')} />
              </div>
              ...
              <div className="space-y-2">
                ...
                <Textarea 
                  ...
                  placeholder="What's your location? What are your current marketing goals? What challenges are you facing in your local market?" 
              ...
              <div className="flex items-center justify-end gap-3 pt-2">
                ...
                <Button type="submit" variant="hero" disabled={isSubmitting}>
                  {isSubmitting ? 'Submitting...' : 'Schedule Local Consultation'}
                </Button>
              </div>
            </form>
          )}
