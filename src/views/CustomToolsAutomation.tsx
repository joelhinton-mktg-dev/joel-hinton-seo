...
import { Zap, CheckCircle, ArrowRight, Calendar, TrendingUp, BarChart3, Bot, Database, Shield, Target, Cog, Workflow, LineChart, FileText, Settings, Gauge, PieChart, RefreshCw, Bell, Mail, Search, Users, Clock, Sparkles } from 'lucide-react';
...
const CustomToolsAutomation = () => {
  const { isOpen, selectedService, openDialog, closeDialog, selectService } = useContactDialog('Marketing Automation Consultation');

  return (
    <>
      <Helmet>
        <title>Custom Digital Marketing Tools & Automation | AIO Growth SEO</title>
        <meta name="description" content="Custom SEO automation tools, lead generation systems, reporting dashboards, and workflow automation. Purpose-built marketing technology that fits your exact business needs." />
        <meta name="keywords" content="SEO automation tools, marketing automation, lead generation systems, reporting dashboards, workflow automation, custom marketing tools, SEO reporting, automated lead capture" />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://aiogrowthseo.com/custom-tools-automation" />

        <meta property="og:title" content="Custom Digital Marketing Tools & Automation | AIO Growth SEO" />
        <meta property="og:description" content="Purpose-built SEO tools, lead systems, and marketing automation designed for your specific business workflows." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://aiogrowthseo.com/custom-tools-automation" />
      </Helmet>
...
export default CustomToolsAutomation;
