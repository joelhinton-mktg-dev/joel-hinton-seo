      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16 slide-up" style={{ animationDelay: "300ms" }}>
            <Button variant="hero" size="lg" className="px-8 py-4 text-lg group transition-all duration-300 will-change-transform">
              Get Free SEO Audit
              <Zap className="w-5 h-5 ml-2 icon-pop" />
            </Button>
            <Button variant="professional" size="lg" className="px-8 py-4 text-lg group transition-all duration-300 will-change-transform">
              View Case Studies
